...
# Desc:  Script to generate performacne of a static model trained on 10% of the dataset on the three Streams
...
chunk_accuracy_list = [float(sum(error_list[i:i + accuracy_chunking])) / accuracy_chunking for i in
                       range(0, len(error_list), accuracy_chunking)]
