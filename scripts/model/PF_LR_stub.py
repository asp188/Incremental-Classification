...
multiplier = math.floor(float(accuracy_chunking) / chunk_size)
...
op = [{"dataset": dataset, "noofexpts": no_of_expts, "accuracy_chunk_size": accuracy_chunking, "chunk_size": chunk_size,
       "nop": nop, "confidence_interval": list(R), "chunk_accuracy": chunk_accuracy, "error_list": error}]
